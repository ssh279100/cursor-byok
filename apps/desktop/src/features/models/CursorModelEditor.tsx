...
import { BUILTIN_PROVIDER } from "../../custom/builtinProvider";
...
export function CursorModelEditor({ draft, modelOptions, discovering, onChange, onDiscover }: {
  ...
  const isBuiltinProvider = trimTrailingSlash(draft.model.base_url.trim()) === BUILTIN_PROVIDER.baseUrl;
  ...
  return <div className={styles.editor}>
    {!isBuiltinProvider && <CursorPresetChips type={draft.model.type} baseUrl={draft.model.base_url} onPick={applyPreset} />}
    <div className={styles.grid}>
      ...
      {!isBuiltinProvider && <div className={styles.urlField}>
